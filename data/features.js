...
export const checklistItems = [
  { text: "Katılımcılarınızı basitçe kayıt edin." },
  { text: "Katılımcıları gruplara ayırarak daha verimli toplantılar düzenleyin." },
  { text: "Toplantıya katılacak grupları seçerek toplantı başlatın." },
  { text: "Toplantılarınızın verimliliğini analiz edin ve iyileştirin." },
  { text: "Veya misafirlerinizi toplantıya davet etmek için link paylaşın." },
];
...
export const featureItems = [
  {
    ...
    description:
      "Tüm paketlerimizle kesintisiz canlı destek hizmetimizden faydalanarak, ihtiyaç duyduğunuz her an yardım alabilirsiniz.",
    link: "#",
  },
  {
    id: 2,
    ...
    description:
      "Basit ve sezgisel tasarımımız sayesinde, toplantılarınızı kolayca yönetebilir ve katılımcılarınızı verimli bir şekilde organize edebilirsiniz.",
    link: "#",
  },
  {
    id: 3,
    ...
    description:
      "Tüm veri transferleriniz, en üst düzey güvenlik protokolleri ile korunur, böylece bilgileriniz her zaman güvende kalır.",
    link: "#",
  },
];
...
export const features8 = [
  {
    ...
    title: "1. KVKK Uygunluğu",
    description: "Türkiye'de KVKK kurallarına uygun tek online toplantı platformu.",
  },
  {
    id: 2,
    iconSrc: "/assets/img/icons/lineal/calendar.svg",
    iconColorClass: "text-green mb-3",
    title: "2. Hızlıca Planla",
    description: "Takviminizden tarih seçerek çok detaylı hızlıca toplantı planlayarabilirsiniz.",
  },
  {
    id: 3,
    iconSrc: "/assets/img/icons/lineal/group.svg",
    iconColorClass: "text-yellow mb-3",
    title: "3. Grupları Yönetme",
    description: "Katılımcıları hızlıca oluştururken onları gruplara ekleyip kolayca yönetebilirsiniz.",
  },
];
...
export const features10 = [
  {
    ...
    iconSrc: "/assets/img/icons/lineal/megaphone.svg",
    title: "Canlı Destek",
    description: "Toplantılarınız sırasında 7/24 erişilebilir canlı destek hizmeti sunuyoruz.",
  },
  {
    id: 2,
    iconSrc: "/assets/img/icons/lineal/target.svg",
    title: "Etkili Toplantı Yönetimi",
    description: "Kolay ve etkili toplantı yönetimi ile katılımcılarınızı verimli bir şekilde organize edin.",
  },
  {
    id: 3,
    iconSrc: "/assets/img/icons/lineal/settings-3.svg",
    title: "Kolay Entegrasyon",
    description: "Mevcut sistemlerinize hızlı ve sorunsuz entegrasyon, iş akışınızı kesintiye uğratmadan çalışır.",
  },
  {
    id: 4,
    iconSrc: "/assets/img/icons/lineal/bar-chart.svg",
    title: "Detaylı Analizler",
    description: "Toplantılarınızın verimliliğini artırmak için kapsamlı analiz ve raporlama araçları.",
  },
];
